...
* In the search bar, type `signin.office365x24.com` and click Search. Under `DOMAINS`, click signin.office365x24.com to complete the search. Below are the screenshots of the legacy view, VT, and IP address `40.100.174.34`.
  ...
  * Image 1 Legacy View
  ...
  ![chrome_QnyIg5thvH](https://github.com/Fulgeo/Google-Cybersecurity-Professional-Certificate/blob/main/Image/siem%26ids/1.png)

  * Image 2 VT 
  
  ![chrome_u1p0eD2S4u](https://github.com/Fulgeo/Google-Cybersecurity-Professional-Certificate/blob/main/Image/siem%26ids/2.png)

  * Image 3 IP address `40.100.174.34`
  
  ![chrome_WS7N0VCXT1](https://github.com/Fulgeo/Google-Cybersecurity-Professional-Certificate/blob/main/Image/siem%26ids/3.png)
